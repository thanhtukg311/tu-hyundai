        ...
        <div id="content">
            <div class="menu_content">
                <ul class="container menu_cnt_top">
                    <li><a href="#"><p><i class="fal fa-sliders-h"></i><span>Chọn xe</span></p></a></li>
                    <li><a href="#"><p><i class="fal fa-map-marker-alt"></i><span>Tìm đại lý</span></p></a></li>
                    <li><a href="#"><p><i class="far fa-steering-wheel"></i><span>Đăng ký lái thử</span></p></a></li>
                    <li><a href="#"><p><i class="fal fa-repeat"></i><span>So sánh</span></p></a></li>
