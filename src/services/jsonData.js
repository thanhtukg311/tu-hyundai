const products = [
    {
        ...
        'utilities': {
            ...
            'main_title': 'Màn hình tầm trung cảm ứng 8 inch',
        ...
        'highlights': {
            ...
            'main_title2': 'Tiện nghi & an toàn trên từng cây số',
            'main_desc2': 'Khoang nội thất của Grand i10 All New là tất cả những gì bạn cần. Đó là sự rộng rãi của không gian kết hợp cùng các tính năng an toàn vượt tầm phân khúc.',
            'list_desc' : [
                {
                    'img': '/product/highligt1.jpg',
            ...
            'list_desc_2' : [
                {
                    'img': '/product/hi_desc1.jpg',
                    'title': 'Cụm điểu chỉnh media tích hợp nhận diện giọng nói',
                    'desc': '',
                },
                {
                    'img': '/product/hi_desc2.jpg',
                    'title': 'Màn hình giải trí 8 inch',
                    'desc': '',
                },
                {
            ...
            'version_compare':[
                ...
                {'name': 'Động Cơ, Hộp số & Vận hành',
                    "content":[
                        ...
                        {
                            "title": "Lốp dự phòng",
                            "desc": ["Vành cùng cỡ","Vành cùng cỡ","Vành giảm cỡ"]
                        },
                        {
                            "title": "Chất liệu lazang",
                            "desc": ["Vành Thép","Vành Thép","Vành Đúc hợp kim"]
                        },
                ...
                {'name': 'Nội thất',
                    "content":[
                        ...
                        {
                            "title": "Chỉnh ghế lái",
                            "desc": ["Chỉnh cơ 4 hướng","Chỉnh cơ 4 hướng","Chỉnh cơ 6 hướng"]
                        },
                        {
                        ...
                        {
                            "title": "Điều hòa",
                            "desc": ["Chỉnh cơ","Chỉnh cơ","Chỉnh cơ"]
                        },
                        {
                            "title": "Cụm màn thông tin",
                            "desc": ["2.8 inch","Màn hình LCD 5.3 inch","Màn hình LCD 5.3 inch"]
                        },
                        {
                    ...
                    'version_table':[
                        ...
                        {'name': 'Ngoại thất',
                            "content":[
                                ...
                                {
                                    "title": "Gương chiếu hậu chỉnh điện",
                                    "desc": "Có gập điện, tích hợp đèn báo rẽ"
                                },
                                {
                                    "title": "Tay nắm cửa mạ crom",
                                    "desc": "Có"
    ...
    },
    {
        ...
        'highlights': {
            ...
            'list_desc' : [
                {
                    'img': '/Grandi10/noibat/h1.png',
                    'title': 'Cụm đèn ban ngày DRL (Daytime Running Light) được thiết kế phá cách dạng boomerang',
                    'desc': '',
                },
                {
                    'img': '/Grandi10/noibat/h2.jpg',
                    'title': 'Ốp trang trí thể thao',
                    'desc': '',
                },
                {
                    'img': '/Grandi10/noibat/h3.jpg',
                    'title': 'Vành hợp kim 15 inch cao cấp tạo hình trẻ trung',
                    'desc': '',
                },
            ],
